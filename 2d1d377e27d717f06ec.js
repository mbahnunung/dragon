...
$('#top-2').click(function () {
    $.kast({
        ...
        version: 2,
        sid: 1,
        directStreamURL: 'https://sertanejapop.herokuapp.com/?q=http://87.98.216.129:4638/;',
        defaultArtwork: ['no-cover-large.png'],
        irrelevantWords: false,
        colors: 'dynamic',
        theme: 'dynamic',
...
$('#top-4').click(function () {
    $.kast({
        ...
        port: 8000,
        version: 2,
        directStreamURL: 'https://sertanejapop.herokuapp.com/?q=http://live.radiobintangtenggara.com:8000/mbahnunungonline',
...
$('#top-11').click(function () {
    $.kast({
        ...
        sid: 1,
        protocol: 'http',
        directStreamURL: 'https://sertanejapop.herokuapp.com/?q=http://live.radiotawangalun.com:8060/rsta',
        irrelevantWords: false,
        colors: 'dynamic',
        theme: 'dynamic',
